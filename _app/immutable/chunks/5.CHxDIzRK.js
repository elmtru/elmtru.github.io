var ba=Object.freeze,Da=Object.defineProperty;var Y=(p,a)=>ba(Da(p,"raw",{value:ba(a||p.slice())}));import{s as sa,e as y,b as w,d as M,g as k,Q as x,i as m,M as _a,p as F,h as na,N as Oa,a as T,O as Wa,f as P,j as aa,I as ca,J as ua,V as Z,c as O,u as W,k as R,m as q,H as ia,v as D,E as ka}from"./scheduler.JiC8KFoJ.js";import{S as ta,i as ea,t as f,g as fa,f as ga,a as d,c as C,d as j,m as S,e as B,b as ra}from"./index.C8QghjAH.js";import{C as oa}from"./CodeLinks.NhsnNu6v.js";import{e as A}from"./each.A9v7PxhN.js";import{f as Ra}from"./index.BCZaT-VP.js";import{C as U,a as qa}from"./ColorScaleSelect.rR1hccnu.js";import{d as Na,P as Fa}from"./PeriodicTable.C6ndjX78.js";import{P as Ja}from"./PropertySelect.COZK-BwV.js";import{T as Qa}from"./TableInset.DhGZlLRs.js";function $a(p,a,e){const t=p.slice();return t[1]=a[e][0],t[2]=a[e][1],t[3]=a[e][2],t[4]=a[e][3],t[5]=a[e][4],t}function va(p){let a,e,t;return a=new U({props:{label:p[1]+"<br>• tick side="+p[2]+"<br>• range="+p[4],color_scale:p[1],tick_side:p[2],tick_labels:p[3],range:p[4],label_style:"white-space: nowrap; padding-right: 1em;"}}),{c(){e=y("div"),C(a.$$.fragment),this.h()},l(n){e=w(n,"DIV",{style:!0});var s=M(e);j(a.$$.fragment,s),this.h()},h(){x(e,"display","contents"),x(e,"--cbar-width","100%"),x(e,"--cbar-padding","2em")},m(n,s){m(n,e,s),S(a,e,null),t=!0},p:F,i(n){t||(f(a.$$.fragment,n),t=!0)},o(n){d(a.$$.fragment,n),t=!1},d(n){n&&a&&k(e),B(a,n)}}}function Ua(p){let a,e,t=A(p[0]),n=[];for(let l=0;l<t.length;l+=1)n[l]=va($a(p,t,l));const s=l=>d(n[l],1,1,()=>{n[l]=null});return{c(){a=y("div");for(let l=0;l<n.length;l+=1)n[l].c();this.h()},l(l){a=w(l,"DIV",{style:!0});var c=M(a);for(let o=0;o<n.length;o+=1)n[o].l(c);c.forEach(k),this.h()},h(){x(a,"border","0.1px dashed white")},m(l,c){m(l,a,c);for(let o=0;o<n.length;o+=1)n[o]&&n[o].m(a,null);e=!0},p(l,[c]){if(c&1){t=A(l[0]);let o;for(o=0;o<t.length;o+=1){const g=$a(l,t,o);n[o]?(n[o].p(g,c),f(n[o],1)):(n[o]=va(g),n[o].c(),f(n[o],1),n[o].m(a,null))}for(fa(),o=t.length;o<n.length;o+=1)s(o);ga()}},i(l){if(!e){for(let c=0;c<t.length;c+=1)f(n[c]);e=!0}},o(l){n=n.filter(Boolean);for(let c=0;c<n.length;c+=1)d(n[c]);e=!1},d(l){l&&k(a),_a(n,l)}}}function Aa(p){return[[["Viridis","top",[0,.25,.5,.75,1]],["Magma","center",[],[100,1631]],["Cividis","bottom",[],[-99.9812,-10]]]]}class Ga extends ta{constructor(a){super(),ea(this,a,Aa,Ua,sa,{})}}function ya(p,a,e){const t=p.slice();return t[1]=a[e],t[3]=e,t}function wa(p,a,e){const t=p.slice();t[4]=a[e];const n=t[4].replace("interpolate","");return t[5]=n,t}function Ca(p){let a,e,t;return e=new U({props:{label:p[5],color_scale:p[5],label_side:p[1],label_style:"min-width: 5em;"}}),{c(){a=y("li"),C(e.$$.fragment),this.h()},l(n){a=w(n,"LI",{class:!0});var s=M(a);j(e.$$.fragment,s),s.forEach(k),this.h()},h(){na(a,"class","svelte-1u1zcz5")},m(n,s){m(n,a,s),S(e,a,null),t=!0},p:F,i(n){t||(f(e.$$.fragment,n),t=!0)},o(n){d(e.$$.fragment,n),t=!1},d(n){n&&k(a),B(e)}}}function ja(p){let a,e,t,n,s,l,c=A(p[0].slice(p[3]*5,5*p[3]+5)),o=[];for(let i=0;i<c.length;i+=1)o[i]=Ca(wa(p,c,i));const g=i=>d(o[i],1,1,()=>{o[i]=null});return{c(){a=y("ul"),e=y("code"),t=Oa(p[1]),n=T();for(let i=0;i<o.length;i+=1)o[i].c();s=T(),this.h()},l(i){a=w(i,"UL",{class:!0});var h=M(a);e=w(h,"CODE",{class:!0});var u=M(e);t=Wa(u,p[1]),u.forEach(k),n=P(h);for(let $=0;$<o.length;$+=1)o[$].l(h);s=P(h),h.forEach(k),this.h()},h(){na(e,"class","svelte-1u1zcz5"),na(a,"class","svelte-1u1zcz5")},m(i,h){m(i,a,h),aa(a,e),aa(e,t),aa(a,n);for(let u=0;u<o.length;u+=1)o[u]&&o[u].m(a,null);aa(a,s),l=!0},p(i,h){if(h&1){c=A(i[0].slice(i[3]*5,5*i[3]+5));let u;for(u=0;u<c.length;u+=1){const $=wa(i,c,u);o[u]?(o[u].p($,h),f(o[u],1)):(o[u]=Ca($),o[u].c(),f(o[u],1),o[u].m(a,s))}for(fa(),u=c.length;u<o.length;u+=1)g(u);ga()}},i(i){if(!l){for(let h=0;h<c.length;h+=1)f(o[h]);l=!0}},o(i){o=o.filter(Boolean);for(let h=0;h<o.length;h+=1)d(o[h]);l=!1},d(i){i&&k(a),_a(o,i)}}}function Ka(p){let a,e,t=A(["top","bottom","left","right"]),n=[];for(let l=0;l<4;l+=1)n[l]=ja(ya(p,t,l));const s=l=>d(n[l],1,1,()=>{n[l]=null});return{c(){a=y("section");for(let l=0;l<4;l+=1)n[l].c();this.h()},l(l){a=w(l,"SECTION",{class:!0});var c=M(a);for(let o=0;o<4;o+=1)n[o].l(c);c.forEach(k),this.h()},h(){na(a,"class","svelte-1u1zcz5")},m(l,c){m(l,a,c);for(let o=0;o<4;o+=1)n[o]&&n[o].m(a,null);e=!0},p(l,[c]){if(c&1){t=A(["top","bottom","left","right"]);let o;for(o=0;o<4;o+=1){const g=ya(l,t,o);n[o]?(n[o].p(g,c),f(n[o],1)):(n[o]=ja(g),n[o].c(),f(n[o],1),n[o].m(a,null))}for(fa(),o=4;o<4;o+=1)s(o);ga()}},i(l){if(!e){for(let c=0;c<4;c+=1)f(n[c]);e=!0}},o(l){n=n.filter(Boolean);for(let c=0;c<4;c+=1)d(n[c]);e=!1},d(l){l&&k(a),_a(n,l)}}}function Xa(p){return[Object.keys(Na).filter(e=>e.startsWith("interpolate"))]}class Ya extends ta{constructor(a){super(),ea(this,a,Xa,Ka,sa,{})}}function Za(p){let a,e,t,n,s,l,c,o,g,i,h;return a=new U({props:{wrapper_style:ma,style:"width: 10em; height: 1ex;"}}),s=new U({props:{label:"Viridis",wrapper_style:ma,style:"width: 3em; height: 2em;"}}),g=new U({props:{wrapper_style:ma}}),{c(){C(a.$$.fragment),e=T(),t=y("br"),n=T(),C(s.$$.fragment),l=T(),c=y("br"),o=T(),i=y("div"),C(g.$$.fragment),this.h()},l(u){j(a.$$.fragment,u),e=P(u),t=w(u,"BR",{}),n=P(u),j(s.$$.fragment,u),l=P(u),c=w(u,"BR",{}),o=P(u),i=w(u,"DIV",{style:!0});var $=M(i);j(g.$$.fragment,$),this.h()},h(){x(i,"display","contents"),x(i,"--cbar-width","8em"),x(i,"--cbar-height","2em")},m(u,$){S(a,u,$),m(u,e,$),m(u,t,$),m(u,n,$),S(s,u,$),m(u,l,$),m(u,c,$),m(u,o,$),m(u,i,$),S(g,i,null),h=!0},p:F,i(u){h||(f(a.$$.fragment,u),f(s.$$.fragment,u),f(g.$$.fragment,u),h=!0)},o(u){d(a.$$.fragment,u),d(s.$$.fragment,u),d(g.$$.fragment,u),h=!1},d(u){u&&(k(e),k(t),k(n),k(l),k(c),k(o)),B(a,u),B(s,u),u&&g&&k(i),B(g,u)}}}const ma="place-items: center;";class an extends ta{constructor(a){super(),ea(this,a,null,Za,sa,{})}}function nn(p){let a,e,t,n;function s(c){p[7](c)}let l={color_scale:p[2],range:p[4],tick_labels:5,tick_side:"bottom"};return p[3]!==void 0&&(l.nice_range=p[3]),a=new U({props:l}),ca.push(()=>ra(a,"nice_range",s)),{c(){e=y("div"),C(a.$$.fragment),this.h()},l(c){e=w(c,"DIV",{style:!0});var o=M(e);j(a.$$.fragment,o),this.h()},h(){x(e,"display","contents"),x(e,"--cbar-width","100%"),x(e,"--cbar-height","15pt")},m(c,o){m(c,e,o),S(a,e,null),n=!0},p(c,o){const g={};o&4&&(g.color_scale=c[2]),o&16&&(g.range=c[4]),!t&&o&8&&(t=!0,g.nice_range=c[3],ua(()=>t=!1)),a.$set(g)},i(c){n||(f(a.$$.fragment,c),n=!0)},o(c){d(a.$$.fragment,c),n=!1},d(c){c&&a&&k(e),B(a,c)}}}function sn(p){let a,e;return a=new Qa({props:{slot:"inset",style:"place-items: center; padding: 2em;",$$slots:{default:[nn]},$$scope:{ctx:p}}}),{c(){C(a.$$.fragment)},l(t){j(a.$$.fragment,t)},m(t,n){S(a,t,n),e=!0},p(t,n){const s={};n&540&&(s.$$scope={dirty:n,ctx:t}),a.$set(s)},i(t){e||(f(a.$$.fragment,t),e=!0)},o(t){d(a.$$.fragment,t),e=!1},d(t){B(a,t)}}}function tn(p){let a,e,t,n,s,l,c,o,g,i;function h(_){p[5](_)}let u={minSelect:1};p[2]!==void 0&&(u.value=p[2]),e=new qa({props:u}),ca.push(()=>ra(e,"value",h));function $(_){p[6](_)}let I={};p[0]!==void 0&&(I.key=p[0]),s=new Ja({props:I}),ca.push(()=>ra(s,"key",$));function J(_){p[8](_)}let V={heatmap_values:p[1],style:"margin: 2em auto 4em;",color_scale_range:p[3]??p[4],links:"name",lanth_act_tiles:!1,$$slots:{inset:[sn]},$$scope:{ctx:p}};return p[2]!==void 0&&(V.color_scale=p[2]),o=new Fa({props:V}),ca.push(()=>ra(o,"color_scale",J)),{c(){a=y("form"),C(e.$$.fragment),n=T(),C(s.$$.fragment),c=T(),C(o.$$.fragment),this.h()},l(_){a=w(_,"FORM",{class:!0});var v=M(a);j(e.$$.fragment,v),n=P(v),j(s.$$.fragment,v),v.forEach(k),c=P(_),j(o.$$.fragment,_),this.h()},h(){na(a,"class","svelte-1fw3r7a")},m(_,v){m(_,a,v),S(e,a,null),aa(a,n),S(s,a,null),m(_,c,v),S(o,_,v),i=!0},p(_,[v]){const H={};!t&&v&4&&(t=!0,H.value=_[2],ua(()=>t=!1)),e.$set(H);const E={};!l&&v&1&&(l=!0,E.key=_[0],ua(()=>l=!1)),s.$set(E);const z={};v&2&&(z.heatmap_values=_[1]),v&24&&(z.color_scale_range=_[3]??_[4]),v&540&&(z.$$scope={dirty:v,ctx:_}),!g&&v&4&&(g=!0,z.color_scale=_[2],ua(()=>g=!1)),o.$set(z)},i(_){i||(f(e.$$.fragment,_),f(s.$$.fragment,_),f(o.$$.fragment,_),i=!0)},o(_){d(e.$$.fragment,_),d(s.$$.fragment,_),d(o.$$.fragment,_),i=!1},d(_){_&&(k(a),k(c)),B(e),B(s),B(o,_)}}}function en(p,a,e){let t,n,s="Viridis",l,c=n;function o(u){s=u,e(2,s)}function g(u){l=u,e(0,l)}function i(u){c=u,e(3,c)}function h(u){s=u,e(2,s)}return p.$$.update=()=>{p.$$.dirty&1&&e(1,t=l?Ra.map(u=>u[l]):[]),p.$$.dirty&2&&e(4,n=[Math.min(...t),Math.max(...t)])},[l,t,s,c,n,o,g,i,h]}class pn extends ta{constructor(a){super(),ea(this,a,en,tn,sa,{})}}const ln=p=>({}),Sa=p=>({slot:"example"}),on=p=>({}),Ba=p=>({slot:"code"}),cn=p=>({}),Ta=p=>({slot:"example"}),un=p=>({}),Pa=p=>({slot:"code"}),rn=p=>({}),Ma=p=>({slot:"example"}),kn=p=>({}),Ia=p=>({slot:"code"}),mn=p=>({}),Ea=p=>({slot:"example"}),_n=p=>({}),Va=p=>({slot:"code"});function fn(p){let a,e;return a=new Ga({}),{c(){C(a.$$.fragment)},l(t){j(a.$$.fragment,t)},m(t,n){S(a,t,n),e=!0},i(t){e||(f(a.$$.fragment,t),e=!0)},o(t){d(a.$$.fragment,t),e=!1},d(t){B(a,t)}}}function gn(p){let a;const e=p[0].default,t=O(e,p,p[1],Ea),n=t||fn();return{c(){n&&n.c()},l(s){n&&n.l(s)},m(s,l){n&&n.m(s,l),a=!0},p(s,l){t&&t.p&&(!a||l&2)&&W(t,e,s,s[1],a?q(e,s[1],l,mn):R(s[1]),Ea)},i(s){a||(f(n,s),a=!0)},o(s){d(n,s),a=!1},d(s){n&&n.d(s)}}}function dn(p){let a,e=`<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span><span class="token punctuation">></span></span><span class="token script"><span class="token language-javascript">
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>`,t;return{c(){a=new ia(!1),t=D(),this.h()},l(n){a=ka(n,!1),t=D(),this.h()},h(){a.a=t},m(n,s){a.m(e,n,s),m(n,t,s)},p:F,d(n){n&&(k(t),a.d())}}}function hn(p){let a;const e=p[0].default,t=O(e,p,p[1],Va),n=t||dn();return{c(){n&&n.c()},l(s){n&&n.l(s)},m(s,l){n&&n.m(s,l),a=!0},p(s,l){t&&t.p&&(!a||l&2)&&W(t,e,s,s[1],a?q(e,s[1],l,_n):R(s[1]),Va)},i(s){a||(f(n,s),a=!0)},o(s){d(n,s),a=!1},d(s){n&&n.d(s)}}}function bn(p){let a,e;return a=new Ya({}),{c(){C(a.$$.fragment)},l(t){j(a.$$.fragment,t)},m(t,n){S(a,t,n),e=!0},i(t){e||(f(a.$$.fragment,t),e=!0)},o(t){d(a.$$.fragment,t),e=!1},d(t){B(a,t)}}}function $n(p){let a;const e=p[0].default,t=O(e,p,p[1],Ma),n=t||bn();return{c(){n&&n.c()},l(s){n&&n.l(s)},m(s,l){n&&n.m(s,l),a=!0},p(s,l){t&&t.p&&(!a||l&2)&&W(t,e,s,s[1],a?q(e,s[1],l,rn):R(s[1]),Ma)},i(s){a||(f(n,s),a=!0)},o(s){d(n,s),a=!1},d(s){n&&n.d(s)}}}function vn(p){let a,e=`<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span><span class="token punctuation">></span></span><span class="token script"><span class="token language-javascript">
  <span class="token keyword">import</span> <span class="token punctuation">{</span> ColorBar <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'$lib'</span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>section</span><span class="token punctuation">></span></span>
  <span class="token each"><span class="token punctuation">{</span><span class="token keyword">#each</span> <span class="token language-javascript"><span class="token punctuation">[</span><span class="token template-string"><span class="token template-punctuation string">\`</span><span class="token string">top</span><span class="token template-punctuation string">\`</span></span><span class="token punctuation">,</span> <span class="token template-string"><span class="token template-punctuation string">\`</span><span class="token string">bottom</span><span class="token template-punctuation string">\`</span></span><span class="token punctuation">,</span> <span class="token template-string"><span class="token template-punctuation string">\`</span><span class="token string">left</span><span class="token template-punctuation string">\`</span></span><span class="token punctuation">,</span> <span class="token template-string"><span class="token template-punctuation string">\`</span><span class="token string">right</span><span class="token template-punctuation string">\`</span></span><span class="token punctuation">]</span> </span><span class="token keyword">as</span> <span class="token language-javascript">label_side<span class="token punctuation">,</span> idx<span class="token punctuation">}</span></span></span>
    ...
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>ul</span><span class="token punctuation">></span></span>
  <span class="token each"><span class="token punctuation">{</span><span class="token keyword">/each</span><span class="token punctuation">}</span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>section</span><span class="token punctuation">></span></span>`,t;return{c(){a=new ia(!1),t=D(),this.h()},l(n){a=ka(n,!1),t=D(),this.h()},h(){a.a=t},m(n,s){a.m(e,n,s),m(n,t,s)},p:F,d(n){n&&(k(t),a.d())}}}function yn(p){let a;const e=p[0].default,t=O(e,p,p[1],Ia),n=t||vn();return{c(){n&&n.c()},l(s){n&&n.l(s)},m(s,l){n&&n.m(s,l),a=!0},p(s,l){t&&t.p&&(!a||l&2)&&W(t,e,s,s[1],a?q(e,s[1],l,kn):R(s[1]),Ia)},i(s){a||(f(n,s),a=!0)},o(s){d(n,s),a=!1},d(s){n&&n.d(s)}}}function wn(p){let a,e;return a=new an({}),{c(){C(a.$$.fragment)},l(t){j(a.$$.fragment,t)},m(t,n){S(a,t,n),e=!0},i(t){e||(f(a.$$.fragment,t),e=!0)},o(t){d(a.$$.fragment,t),e=!1},d(t){B(a,t)}}}function Cn(p){let a;const e=p[0].default,t=O(e,p,p[1],Ta),n=t||wn();return{c(){n&&n.c()},l(s){n&&n.l(s)},m(s,l){n&&n.m(s,l),a=!0},p(s,l){t&&t.p&&(!a||l&2)&&W(t,e,s,s[1],a?q(e,s[1],l,cn):R(s[1]),Ta)},i(s){a||(f(n,s),a=!0)},o(s){d(n,s),a=!1},d(s){n&&n.d(s)}}}function jn(p){let a,e=`<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span><span class="token punctuation">></span></span><span class="token script"><span class="token language-javascript">
  <span class="token keyword">import</span> <span class="token punctuation">{</span> ColorBar <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'$lib'</span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>br</span> <span class="token punctuation">/></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>ColorBar</span> <span class="token language-javascript"><span class="token punctuation">{</span>wrapper_style<span class="token punctuation">}</span></span> <span class="token attr-name">--cbar-width</span><span class="token attr-value"><span class="token punctuation">=</span><span class="token punctuation">"</span>8em<span class="token punctuation">"</span></span> <span class="token attr-name">--cbar-height</span><span class="token attr-value"><span class="token punctuation">=</span><span class="token punctuation">"</span>2em<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span>`,t;return{c(){a=new ia(!1),t=D(),this.h()},l(n){a=ka(n,!1),t=D(),this.h()},h(){a.a=t},m(n,s){a.m(e,n,s),m(n,t,s)},p:F,d(n){n&&(k(t),a.d())}}}function Sn(p){let a;const e=p[0].default,t=O(e,p,p[1],Pa),n=t||jn();return{c(){n&&n.c()},l(s){n&&n.l(s)},m(s,l){n&&n.m(s,l),a=!0},p(s,l){t&&t.p&&(!a||l&2)&&W(t,e,s,s[1],a?q(e,s[1],l,un):R(s[1]),Pa)},i(s){a||(f(n,s),a=!0)},o(s){d(n,s),a=!1},d(s){n&&n.d(s)}}}function Bn(p){let a,e;return a=new pn({}),{c(){C(a.$$.fragment)},l(t){j(a.$$.fragment,t)},m(t,n){S(a,t,n),e=!0},i(t){e||(f(a.$$.fragment,t),e=!0)},o(t){d(a.$$.fragment,t),e=!1},d(t){B(a,t)}}}function Tn(p){let a;const e=p[0].default,t=O(e,p,p[1],Sa),n=t||Bn();return{c(){n&&n.c()},l(s){n&&n.l(s)},m(s,l){n&&n.m(s,l),a=!0},p(s,l){t&&t.p&&(!a||l&2)&&W(t,e,s,s[1],a?q(e,s[1],l,ln):R(s[1]),Sa)},i(s){a||(f(n,s),a=!0)},o(s){d(n,s),a=!1},d(s){n&&n.d(s)}}}function Pn(p){let a,e=`<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span><span class="token punctuation">></span></span><span class="token script"><span class="token language-javascript">
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>PeriodicTable</span><span class="token punctuation">></span></span>`,t;return{c(){a=new ia(!1),t=D(),this.h()},l(n){a=ka(n,!1),t=D(),this.h()},h(){a.a=t},m(n,s){a.m(e,n,s),m(n,t,s)},p:F,d(n){n&&(k(t),a.d())}}}function Mn(p){let a;const e=p[0].default,t=O(e,p,p[1],Ba),n=t||Pn();return{c(){n&&n.c()},l(s){n&&n.l(s)},m(s,l){n&&n.m(s,l),a=!0},p(s,l){t&&t.p&&(!a||l&2)&&W(t,e,s,s[1],a?q(e,s[1],l,on):R(s[1]),Ba)},i(s){a||(f(n,s),a=!0)},o(s){d(n,s),a=!1},d(s){n&&n.d(s)}}}var za,xa,Ha,La;function In(p){let a,e="<code>ColorBar.svelte</code>",t,n,s="<code>ColorBar</code> с подписями:",l,c,o,g,i,h="<code>ColorBar</code> поддерживает <code>label_side = [&#39;top&#39;, &#39;bottom&#39;, &#39;left&#39;, &#39;right&#39;]</code>",u,$,I,J,V,_="У полос могут быть разные размеры:",v,H,E,z,N,da="Тепловая карта <code>PeriodicTable.svelte</code> с <code>ColorBar</code> внутри <code>TableInset</code>",pa,Q,L,la;return o=new oa({props:{src:String.raw(za||(za=Y([`<script>
...
/>
{/each}
</div>`]))),meta:{Wrapper:"svelte-zoo/CodeExample.svelte",filename:"/src/routes/(demos)/color-bar/+page.md",pkg:"elementari",repo:"https://github.com/elmtru/elmtru.github.io",hideStyle:!0,example:!0,stackblitz:!0},$$slots:{code:[hn],example:[gn]},$$scope:{ctx:p}}}),I=new oa({props:{src:String.raw(xa||(xa=Y([`<script>
import { ColorBar } from '$lib'
...
{/each}
</section>`]))),meta:{Wrapper:"svelte-zoo/CodeExample.svelte",filename:"/src/routes/(demos)/color-bar/+page.md",pkg:"elementari",repo:"https://github.com/elmtru/elmtru.github.io",hideStyle:!0,example:!0,stackblitz:!0},$$slots:{code:[yn],example:[$n]},$$scope:{ctx:p}}}),E=new oa({props:{src:String.raw(Ha||(Ha=Y([`<script>
import { ColorBar } from '$lib'
...
<br />
<ColorBar {wrapper_style} --cbar-width="8em" --cbar-height="2em" />`]))),meta:{Wrapper:"svelte-zoo/CodeExample.svelte",filename:"/src/routes/(demos)/color-bar/+page.md",pkg:"elementari",repo:"https://github.com/elmtru/elmtru.github.io",hideStyle:!0,example:!0,stackblitz:!0},$$slots:{code:[Sn],example:[Cn]},$$scope:{ctx:p}}}),L=new oa({props:{src:String.raw(La||(La=Y([`<script>
import {
ColorBar,
ColorScaleSelect,
element_data,
...
</PeriodicTable>`]))),meta:{Wrapper:"svelte-zoo/CodeExample.svelte",filename:"/src/routes/(demos)/color-bar/+page.md",pkg:"elementari",repo:"https://github.com/elmtru/elmtru.github.io",hideStyle:!0,example:!0,stackblitz:!0,code_above:!0},$$slots:{code:[Mn],example:[Tn]},$$scope:{ctx:p}}}),{c(){a=y("p"),a.innerHTML=e,t=T(),n=y("p"),n.innerHTML=s,l=T(),c=y("div"),C(o.$$.fragment),g=T(),i=y("p"),i.innerHTML=h,u=T(),$=y("div"),C(I.$$.fragment),J=T(),V=y("p"),V.textContent=_,v=T(),H=y("div"),C(E.$$.fragment),z=T(),N=y("p"),N.innerHTML=da,pa=T(),Q=y("div"),C(L.$$.fragment)},l(r){a=w(r,"P",{"data-svelte-h":!0}),Z(a)!=="svelte-1lubuts"&&(a.innerHTML=e),t=P(r),n=w(r,"P",{"data-svelte-h":!0}),Z(n)!=="svelte-4i53ck"&&(n.innerHTML=s),l=P(r),c=w(r,"DIV",{});var b=M(c);j(o.$$.fragment,b),b.forEach(k),g=P(r),i=w(r,"P",{"data-svelte-h":!0}),Z(i)!=="svelte-tytfaf"&&(i.innerHTML=h),u=P(r),$=w(r,"DIV",{});var G=M($);j(I.$$.fragment,G),G.forEach(k),J=P(r),V=w(r,"P",{"data-svelte-h":!0}),Z(V)!=="svelte-8q7ld7"&&(V.textContent=_),v=P(r),H=w(r,"DIV",{});var K=M(H);j(E.$$.fragment,K),K.forEach(k),z=P(r),N=w(r,"P",{"data-svelte-h":!0}),Z(N)!=="svelte-85c7g9"&&(N.innerHTML=da),pa=P(r),Q=w(r,"DIV",{});var X=M(Q);j(L.$$.fragment,X),X.forEach(k)},m(r,b){m(r,a,b),m(r,t,b),m(r,n,b),m(r,l,b),m(r,c,b),S(o,c,null),m(r,g,b),m(r,i,b),m(r,u,b),m(r,$,b),S(I,$,null),m(r,J,b),m(r,V,b),m(r,v,b),m(r,H,b),S(E,H,null),m(r,z,b),m(r,N,b),m(r,pa,b),m(r,Q,b),S(L,Q,null),la=!0},p(r,[b]){const G={};b&2&&(G.$$scope={dirty:b,ctx:r}),o.$set(G);const K={};b&2&&(K.$$scope={dirty:b,ctx:r}),I.$set(K);const X={};b&2&&(X.$$scope={dirty:b,ctx:r}),E.$set(X);const ha={};b&2&&(ha.$$scope={dirty:b,ctx:r}),L.$set(ha)},i(r){la||(f(o.$$.fragment,r),f(I.$$.fragment,r),f(E.$$.fragment,r),f(L.$$.fragment,r),la=!0)},o(r){d(o.$$.fragment,r),d(I.$$.fragment,r),d(E.$$.fragment,r),d(L.$$.fragment,r),la=!1},d(r){r&&(k(a),k(t),k(n),k(l),k(c),k(g),k(i),k(u),k($),k(J),k(V),k(v),k(H),k(z),k(N),k(pa),k(Q)),B(o),B(I),B(E),B(L)}}}function En(p,a,e){let{$$slots:t={},$$scope:n}=a;return p.$$set=s=>{"$$scope"in s&&e(1,n=s.$$scope)},[t,n]}class Vn extends ta{constructor(a){super(),ea(this,a,En,In,sa,{})}}const Fn=Object.freeze(Object.defineProperty({__proto__:null,default:Vn},Symbol.toStringTag,{value:"Module"}));export{Vn as P,Fn as _};
