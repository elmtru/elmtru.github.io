var Z=Object.freeze,gn=Object.defineProperty;var nn=(t,n)=>Z(gn(t,"raw",{value:Z(n||t.slice())}));import{s as pn,J as _n,e as d,a as J,N as g,b as $,d as S,V as dn,f as N,O as _,g as r,h as C,i as w,j as u,K as $n,P as G,c as on,u as ln,k as cn,m as un,H as vn,n as an,A as bn,t as hn}from"./scheduler.DSZzDcX6.js";import{S as rn,i as kn,f as Sn,b as R,d as T,m as q,t as E,a as O,e as I}from"./index.Ck97c3H1.js";import{C as yn}from"./CodeLinks.B9P-oswO.js";import"./index.CiUkGHkN.js";import{m as mn}from"./index.Dogy4G_J.js";import{M as jn}from"./MultiSelect.DnLUjMOe.js";import{S as wn}from"./Structure.DD5dfMtl.js";function En(t){let n,p,e="Select a molecule:",s,a,l,V,i,y,B,z,F,k,K,v,U,x=JSON.stringify(t[1],null,2)+"",M,W,Y,P,b,A,H,m,h;function fn(o){t[2](o)}let Q={id:"select",options:mn.map(On),selected:[t[0]],maxSelect:1,minSelect:1};return t[0]!==void 0&&(Q.value=t[0]),a=new jn({props:Q}),_n.push(()=>Sn(a,"value",fn)),m=new wn({props:{structure:t[1],bonding_strategy:"max_dist",bonding_options:{max_bond_dist:2}}}),{c(){n=d("form"),p=d("label"),p.textContent=e,s=J(),R(a.$$.fragment),V=J(),i=d("details"),y=d("summary"),B=g("JSON for molecule "),z=g(t[0]),F=J(),k=d("pre"),K=g(""),v=d("code"),U=g(`
`),M=g(x),W=g(`
`),Y=g(`
