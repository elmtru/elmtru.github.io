...
/>
{/each}
</div>`]))),meta:{Wrapper:"svelte-zoo/CodeExample.svelte",filename:"/src/routes/(demos)/color-bar/+page.md",pkg:"elementari",repo:"https://github.com/elmtru/elmtru.github.io",hideStyle:!0,example:!0,stackblitz:!0},$$slots:{code:[hn],example:[gn]},$$scope:{ctx:p}}}),I=new oa({props:{src:String.raw(xa||(xa=X([`<script>
import { ColorBar } from '$lib'
...
{/each}
</section>`]))),meta:{Wrapper:"svelte-zoo/CodeExample.svelte",filename:"/src/routes/(demos)/color-bar/+page.md",pkg:"elementari",repo:"https://github.com/elmtru/elmtru.github.io",hideStyle:!0,example:!0,stackblitz:!0},$$slots:{code:[yn],example:[$n]},$$scope:{ctx:p}}}),V=new oa({props:{src:String.raw(Ha||(Ha=X([`<script>
import { ColorBar } from '$lib'
